...
public class EventReviewController {
    ...
    public EventReviewController(ReviewService reviewService, CustomUserDetailsService userDetailsService) {
    ...
    public ResponseEntity<ApiResponse<ReviewStatsResponse>> getEventReviewStats(@PathVariable String eventId) {
    ...
    public ResponseEntity<ApiResponse<ReviewResponse>> createReview(
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(ApiResponse.success("Avis créé", response));
    }
